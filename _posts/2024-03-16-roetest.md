...
**Keine 2h später hatte ich HANS-WURST an der Strippe und mit seinen 70+ ein sehr umgänglicher und extrem versierter _Radiobastler_! Kurz darauf Bestellung initiiert und los gings...**

> **HANS-WURST, auch nochmals auf diesem Wege: DANKE, DANKE es ist eine Bereicherung so jemanden kennenzulernen, auch an Deinen Kumpel! Mit was für einer Genauigkeit und Präzision Du das Gerät gebaut hast, Chapêau!** :pray:
...
**HANS-WURST hat mich über mehrere Wochen auf dem "Laufenden" gehalten via WhatsApp und ich kann heute bestätigen, wenn im Forum erwähnt wurde '_sehr aufwendiger Bausatz_'!**
...
### USB zu Serial Treiber

**Der USB 2.0 Anschluß benötigt einen entsprechenden Windows Treiber, damit hier dier virtuelle Seriell-Schnittstelle COM3 erkannt wird!**

**Der Treiber liegt der Software-CD bei, oder einfach mir eine E-Mail senden.**

**Sobald das USB-Kabel vom Roetest (vorher einschalten) an den PC/Laptop eingesteckt wird, dann muss im Gerätemanager automatisch ein COM3-Serial Port auftauchen! Wenn nicht, braucht Ihr erst gar nicht die Software selbst starten ;-)**

<a href="https://ibb.co/JpwMwMH"><img src="https://i.ibb.co/JpwMwMH/Screenshot-USB-driver.png" alt="Screenshot-USB-driver" border="0"></a> <a href="https://ibb.co/h2s4xd6"><img src="https://i.ibb.co/h2s4xd6/Screenshot-USB-Serial-COM3.png" alt="Screenshot-USB-Serial-COM3" border="0"></a>

---

### Ersten Messungen

Natürlich hat mir HANS-WURST und sein Kumpel bei der Abholung eine Einführung für Gaus wie mich durchgeführt, mit einer Engelsdeduld :grimacing: !
